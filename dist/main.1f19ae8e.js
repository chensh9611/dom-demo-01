...
console.log(div1);
dom.after(test, div1);
var div2 = dom.create("<div>yanyan</div>>");
document.body.appendChild(div2);
dom.before(test, div2);
dom.append(test, div2);
var div3 = dom.create("<div>dahao</div>");
dom.wrap(div3, div2); // dom.remove(div2)

var node = dom.empty(window.empty);
console.log(node);
dom.attr(div1, 'title', "wo shi ni baba");
var title = dom.attr(div1, 'title');
console.log(title);
dom.text(div1, "\u4E09\u751F\u4E09\u4E16");
var text = dom.text(div1);
console.log(text);
var div_html = dom.create("<div>\u5403\u996D\u5566</div>");
...
var color = dom.style(div_html, 'color');
